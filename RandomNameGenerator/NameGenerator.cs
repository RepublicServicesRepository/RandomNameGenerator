...
namespace RandomNameGenerator
{
    public static class NameGenerator
    {
        ...
        private static List<string> _males = new List<string>
        {
            "AARON",
            "ABEL",
            "ABRAHAM",
        ...
        private static List<string> _females = new List<string>
        { 
           "ABBIE",
            "ABBY",
            "ABIGAIL",
        ...
        {
            return _males[_random.Next(0, _males.Count)];
        }

        private static string GenerateFemaleName()
        {
            return _females[_random.Next(0, _females.Count)];
        }

        public static string GenerateFirstName(Gender gender)
        {
            return gender == Gender.Male ? GenerateMaleName() : GenerateFemaleName();
        }

        public static string GenerateFirstName()
        {
            return GenerateFirstName(_random.Next(0, 1) == 0 ? Gender.Male : Gender.Female);
        }
